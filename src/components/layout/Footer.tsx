      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-xl font-bold">Zasulehry</span>
            </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {currentYear} Zasulehry. All rights reserved.
          </p>
...
function SocialIcon({ name }: { name: string }) {
  ...
  switch (name) {
    ...
    case 'instagram':
      return (
        <svg className={iconClass} fill="currentColor" viewBox="0 0 24 24">
          <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987s11.987-5.367 11.987-11.987C24.014 5.367 18.647.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.596-3.205-1.533l1.714-1.714c.39.39.927.633 1.491.633.564 0 1.101-.243 1.491-.633.39-.39.633-.927.633-1.491s-.243-1.101-.633-1.491c-.39-.39-.927-.633-1.491-.633-.564 0-1.101.243-1.491.633l-1.714-1.714c.757-.937 1.908-1.533 3.205-1.533 2.347 0 4.244 1.897 4.244 4.244s-1.897 4.244-4.244 4.244zm7.538 0c-2.347 0-4.244-1.897-4.244-4.244s1.897-4.244 4.244-4.244c1.297 0 2.448.596 3.205 1.533l-1.714 1.714c-.39-.39-.927-.633-1.491-.633-.564 0-1.101.243-1.491.633-.39.39-.633.927-.633 1.491s.243 1.101.633 1.491c.39.39.927.633 1.491.633.564 0 1.101-.243 1.491-.633l1.714 1.714c-.757.937-1.908 1.533-3.205 1.533z"/>
        </svg>
      );
    default:
      return (
